...
public class UserDBSqlData {
    ...
    public static final String SQL_DB_INSERT_DATA = "INSERT INTO user "
            +"(uid, user_id, email, name, christ_name, cathedral, created_at)"
            +"VALUES(?, ?, ?, ?, ?, ?, ?)";
    public static final String SQL_DB_UPDATE_DATA = "UPDATE user " + "SET email=?, name=?, christ_name=?, cathedral=?"+" WHERE uid=?";
