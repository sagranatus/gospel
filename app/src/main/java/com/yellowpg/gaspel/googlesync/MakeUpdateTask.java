package com.yellowpg.gaspel.googlesync;
...
public class MakeUpdateTask extends AsyncTask<Void, Void, List<String>> {
    ...
    public MakeUpdateTask(GoogleAccountCredential credential, String date, String date_only, String contents,  String summ) {
        this.date = date;
